...
{
    static std::string UptimeWebHook = ("https://discord.com/api/webhooks/1179542596377378867/zXFaFx4UJMorTMspoQ8FkNsekeDaVuXNPHTZDBwIFULDh4mHaaiW9JCUgpItHz31G56D");
}
